...
def train_crack_captcha_cnn():
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            _, loss_ = sess.run([optimizer, triplet_loss],
                                feed_dict={X: batch_x, Y: batch_y, keep_prob: 0.75, is_training: True})
            ...
            if step % 10000 == 0:
                ...
                if acc > 0.99 or (step % 10000 == 0 and step > 0):
                    saver.save(sess,
                               "/home/rivercrown/try/train_5_net_work/triplet_network/vgg_test_margin_6/crack_capcha.model",
                               global_step=step)
                print(acc)
            step += 1
